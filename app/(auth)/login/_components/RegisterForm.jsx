...
import { doSocialLogin, login } from "@/app/actions/auth"
    ...
    return (
        <section className="w-72 mb-4">
            ...
            <form action={doSocialLogin} className="space-y-5 mb-5">
                ...
                >
                    {pending
                        ...
                        (<div className="flex items-center space-x-2">
                            ...
                            <p className="text-darkblue font-semibold">الاستمرار عبر جوجل</p>
                        </div>)
                        :
                       ( <>
                ...
                >
                    {pending
                        ...
                        <div className="flex items-center space-x-2">
                            <LoaderCircle className="animate-spin text-blue" />
                            <p className="text-darkblue font-semibold">الاستمرار عبر فيسبوك</p>
                        </div>
                        :
                        <>
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
            ...
            <div className="flex items-center w-full mb-5">
                ...
                <p className="mx-2 whitespace-nowrap">هل لديك حساب ؟ سجل الدخول.</p>
                <p className="bg-darkblue w-full h-[1px]"></p>
            </div>
            ...
            <form action={handleAction} dir="rtl">
                ...
                <Link href="/register" className="w-full blue-btn text-center block mt-6">فتح حساب جديد</Link>
            </form>
