...
const ForgotPwd = ( ) => {
    ...
    const handleAction = async (formData) => {
        ...
        const result = await forgotPwd(formData)
            ...
            <DialogContent className="flex flex-col items-center">
                ...
                <form action={handleAction} className="grid gap-4 p-4 overflow-y-auto ">
                    ...
                    <div dir="rtl" className="relative">
                        <input type="email" name="email" placeholder="عنوان البريد الإلكتروني" className="bg-[#007AFF0D] border border-[#1831536E] rounded-md py-3 px-4 w-80 lg:w-96 outline-none focus:ring-[0.8px] focus:ring-ringblue" />
                ...
                :
                <div dir="rtl" className=" text-lg my-6">
                    <p>تم إرسال رسالة إلى بريدك الإلكتروني</p>
                    <p>يرجى التحقق والنقر على الزر.</p>
                </div>
                }
            </DialogContent>
