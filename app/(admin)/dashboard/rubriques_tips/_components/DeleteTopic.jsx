...
import { deleteTopicTip } from "@/app/actions/topic-action"
    ...
    return (
        <Dialog>
            ...
            <DialogContent className="flex flex-col items-center">
                <DialogHeader>
                    <DialogTitle className="text-2xl text-center">Supprimer rubrique</DialogTitle>
                ...
                <DialogTrigger asChild>
                    <form action={deleteTopicTip.bind(null, id)}>
