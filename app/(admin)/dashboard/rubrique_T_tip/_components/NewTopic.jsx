...
import { newTopicTip } from "@/app/actions/topic-action"
...
const NewTopic = ({ tips }) => {
    ...
    const handleAction = async (formData) => {
        const type = 'T-Telecom'
        const result = await newTopicTip(formData, type)
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="flex flex-col items-center lg:h-[55%] custom-scrollbar">
                ...
                <form action={handleAction} className="flex flex-col items-center w-fit">
                    ...
                    <div>
                        <p className="text-sm text-[#94a3b8]">Tips : <span className='text-red text-lg'>*</span></p>
                        <Select
                            options={tips.map((el) => ({
