...
import { editRecipeTopic } from "@/app/actions/topic-action"
import { Skeleton } from "@/components/ui/skeleton"
import { useSortable } from '@dnd-kit/sortable';
import { CSS } from '@dnd-kit/utilities';


export const Topic = ({el, id, title, section, recipes }) => {
                ...
                <AccordionItem value="item-1">
                    ...
                    <AccordionContent>
                        ...
                        <div className="mt-8">
                            ...
                            <EditTopic title={title} section={section} id={id} recipes={recipes} />
                        </div>
                    </AccordionContent>
                </AccordionItem>
            </Accordion>
