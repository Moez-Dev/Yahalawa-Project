...
const InstructionForm = ({ instructionList, setInstructionList , status}) => {
    ...
    return (
        <section>
            <p className="font-semibold mb-3">Instructions : {status?.value !== "brouillon" && <span className='text-red text-lg'>*</span>}</p>
