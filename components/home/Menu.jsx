                                ...
                                <DropdownMenuContent className="p-3 text-center">
                                    ...
                                    <form action={doLogout}>
                                        {session?.user?.role == "SUPER_ADMIN" && "ADMIN" && "T_TELECOM" &&
                                            <div className="mb-2 w-full flex items-center justify-end cursor-pointer hover:text-blue duration-300">
                                                <Link href="/compte">حسابي</Link>
                                                <User className="size-4" />
                                            </div>}
                                        <button type="submit" className=" w-full flex items-center justify-end space-x-2 cursor-pointer hover:text-blue duration-300">
                                            <p>خروج</p>
