                ...
                return (
                    <section key={index} className="w-full mt-6">
                        ...
                        {index === 1 && (
                            <>
                                <div>
                                    <div className="flex items-center w-full mt-16 mb-5">
                                        <span className="bg-[#18315354] w-full h-[0.5px]"></span>
                                    ...
                                    <div dir="rtl" className="flex items-center justify-between flex-wrap space-x-2 lg:space-x-3">
                                        {Array.isArray(randomTags) && randomTags.slice(0, 26).map((el) => {
                                            return (
                                                <Link key={el.id} href={`/tags/${el.id}`} className="bg-red text-white py-3 px-6 mx-3 rounded-sm my-4 hover:bg-blue duration-300">
                                                    {el.title}
                                                </Link>
                                            )
                                        })}
